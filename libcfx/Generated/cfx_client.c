...
int CEF_CALLBACK cfx_client_on_process_message_received(cef_client_t* self, cef_browser_t* browser, cef_frame_t* frame, cef_process_id_t source_process, cef_process_message_t* message) {
    int __retval;
    int browser_release;
    int frame_release;
    int message_release;
    ((cfx_client_t*)self)->on_process_message_received(((cfx_client_t*)self)->gc_handle, &__retval, browser, &browser_release, frame, &frame_release, source_process, message, &message_release);
...
static void cfx_client_set_callback(cef_client_t* self, int index, void* callback) {
    ...
    case 12:
        ...
        break;
    case 13:
        ((cfx_client_t*)self)->on_process_message_received = (void (CEF_CALLBACK *)(gc_handle_t self, int* __retval, cef_browser_t* browser, int *browser_release, cef_frame_t* frame, int *frame_release, cef_process_id_t source_process, cef_process_message_t* message, int *message_release))callback;
